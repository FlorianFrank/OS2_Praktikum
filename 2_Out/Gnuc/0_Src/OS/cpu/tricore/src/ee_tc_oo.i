# 1 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c"
# 56 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c"
...
# 57 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c" 2
...
static void __attribute__((noinline)) EE_tc_dummy_context( EE_TID tid )
{

  EE_terminate_data[tid] = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE00" : "=d" (__res) :: "memory"); __res; }));


  EE_terminate_real_th_body[tid]();
# 128 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c"
  EE_thread_not_terminated();
}


static inline void __attribute__((always_inline)) EE_tc_call_dummy_context( void )
{
...
void EE_hal_terminate_savestk( EE_TID tid )
{
# 151 "0_Src/OS/cpu/tricore/src/ee_tc_oo.c"
