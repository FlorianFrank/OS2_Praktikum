# 1 "0_Src/OS/kernel/oo/src/ee_startos.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_startos.c"
# 46 "0_Src/OS/kernel/oo/src/ee_startos.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_startos.c" 2
# 91 "0_Src/OS/kernel/oo/src/ee_startos.c"
...
# 142 "0_Src/OS/kernel/oo/src/ee_startos.c"
...
# 174 "0_Src/OS/kernel/oo/src/ee_startos.c"
...
StatusType EE_oo_StartOS(AppModeType Mode)
{
  ...
  flag = EE_hal_begin_nested_primitive();
# 232 "0_Src/OS/kernel/oo/src/ee_startos.c"
  ...
  if (rq != ((EE_TID)-1)) {
      ...
      ((void)0);
# 270 "0_Src/OS/kernel/oo/src/ee_startos.c"
