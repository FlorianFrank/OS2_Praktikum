# 1 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
# 46 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_irqendin.c" 2
# 104 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
...
# 131 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
void EE_IRQ_end_instance(void)
{
  register EE_TID tmp;
  ...
  if ((tmp != ((EE_TID)-1)) && (EE_sys_ceiling < EE_th_ready_prio[tmp])) {


    if (tmp_stacked != ((EE_TID)-1)) {

      ((void)0);


      EE_th_status[tmp_stacked] = ((EE_UREG)2U);
    }


    EE_th_status[tmp] = ((EE_UREG)0U);
    ...
    EE_hal_endcycle_stacked(tmp_stacked);
  }
}
...
void EE_IRQ_end_post_stub(void) {
# 180 "0_Src/OS/kernel/oo/src/ee_irqendin.c"
  if (EE_oo_IRQ_disable_count != 0U)
  {
