# 1 "0_Src/OS/kernel/oo/src/ee_evwait.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_evwait.c"
# 46 "0_Src/OS/kernel/oo/src/ee_evwait.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_evwait.c" 2
# 63 "0_Src/OS/kernel/oo/src/ee_evwait.c"
StatusType EE_oo_WaitEvent(EventMaskType Mask)
...

{
  ...
  current = EE_stk_queryfirst();
# 83 "0_Src/OS/kernel/oo/src/ee_evwait.c"
  ...
  if ((EE_hal_get_IRQ_nesting_level() != 0U) || (current==((EE_TID)-1))) {
    ((void)0);
    ...
    return ((StatusType)2U);
  }
# 126 "0_Src/OS/kernel/oo/src/ee_evwait.c"
...
# 156 "0_Src/OS/kernel/oo/src/ee_evwait.c"
