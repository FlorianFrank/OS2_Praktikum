# 1 "0_Src/OS/kernel/oo/src/ee_gettaskstate.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_gettaskstate.c"
# 46 "0_Src/OS/kernel/oo/src/ee_gettaskstate.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_gettaskstate.c" 2
# 55 "0_Src/OS/kernel/oo/src/ee_gettaskstate.c"
StatusType EE_oo_GetTaskState(TaskType TaskID, TaskStateRefType State)
{
  ...
  flag = EE_hal_begin_nested_primitive();
  if (State != (TaskStateRefType)0) {
    *State = EE_th_status[TaskID];
    retVal = ((StatusType)0U);
  } else {
