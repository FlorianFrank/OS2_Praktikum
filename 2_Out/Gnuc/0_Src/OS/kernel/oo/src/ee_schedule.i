# 1 "0_Src/OS/kernel/oo/src/ee_schedule.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_schedule.c"
# 46 "0_Src/OS/kernel/oo/src/ee_schedule.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_schedule.c" 2
# 61 "0_Src/OS/kernel/oo/src/ee_schedule.c"
StatusType EE_oo_Schedule(void)
{
  EE_TID current, rq;
  ...
  current = EE_stk_queryfirst();
# 78 "0_Src/OS/kernel/oo/src/ee_schedule.c"
...
# 121 "0_Src/OS/kernel/oo/src/ee_schedule.c"
  flag = EE_hal_begin_nested_primitive();
  ...
  if (rq != ((EE_TID)-1)) {
    ...
    if (EE_th_ready_prio[current] < EE_th_ready_prio[rq]) {
      ...
      EE_sys_ceiling &= ~EE_th_dispatch_prio[current];
# 148 "0_Src/OS/kernel/oo/src/ee_schedule.c"
