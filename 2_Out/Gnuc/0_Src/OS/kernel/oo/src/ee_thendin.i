# 1 "0_Src/OS/kernel/oo/src/ee_thendin.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_thendin.c"
# 46 "0_Src/OS/kernel/oo/src/ee_thendin.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_thendin.c" 2
...
# 80 "0_Src/OS/kernel/oo/src/ee_thendin.c"
void EE_thread_end_instance(void)
{
...
# 109 "0_Src/OS/kernel/oo/src/ee_thendin.c"
  if( (1U == EE_thread_rnact_max(current)) || (current == TaskID) ) {
    EE_th_status[current] = ((EE_UREG)3U);
  } else {
    EE_th_status[current] = ((EE_UREG)2U);
  }
  ...
  if (TaskID != ((EE_TID)-1)) {
# 139 "0_Src/OS/kernel/oo/src/ee_thendin.c"
  ...
  if (rqfirst == ((EE_TID)-1)) {
    ...
    if (EE_stk_queryfirst() != ((EE_TID)-1)) {
      EE_th_status[EE_stk_queryfirst()] = ((EE_UREG)0U);
    ...
    EE_th_status[rqfirst] = ((EE_UREG)0U);
