# 1 "0_Src/OS/kernel/oo/src/ee_evset.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_evset.c"
# 46 "0_Src/OS/kernel/oo/src/ee_evset.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_evset.c" 2
# 69 "0_Src/OS/kernel/oo/src/ee_evset.c"
StatusType EE_oo_SetEvent(TaskType TaskID, EventMaskType Mask)
...

{
  ...
  ((void)0);
# 105 "0_Src/OS/kernel/oo/src/ee_evset.c"
  ...
  if (EE_th_status[TaskID] == ((EE_UREG)3U)) {
    ...
    return ((StatusType)7U);

  } else {

    EE_th_event_active[TaskID] |= Mask;
# 168 "0_Src/OS/kernel/oo/src/ee_evset.c"
    if (EE_th_event_waitmask[TaskID] & Mask) {
      if (EE_th_status[TaskID] == ((EE_UREG)1U)) {
