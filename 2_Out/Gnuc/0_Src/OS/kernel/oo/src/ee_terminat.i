# 1 "0_Src/OS/kernel/oo/src/ee_terminat.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_terminat.c"
# 46 "0_Src/OS/kernel/oo/src/ee_terminat.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_terminat.c" 2
# 61 "0_Src/OS/kernel/oo/src/ee_terminat.c"
StatusType EE_oo_TerminateTask(void)
{
...
# 100 "0_Src/OS/kernel/oo/src/ee_terminat.c"
  np_flags = EE_hal_begin_nested_primitive();


  EE_th_terminate_nextask[EE_stk_queryfirst()] = ((EE_TID)-1);
