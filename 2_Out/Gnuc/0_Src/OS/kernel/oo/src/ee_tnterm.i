# 1 "0_Src/OS/kernel/oo/src/ee_tnterm.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_tnterm.c"
# 45 "0_Src/OS/kernel/oo/src/ee_tnterm.c"
...
# 46 "0_Src/OS/kernel/oo/src/ee_tnterm.c" 2
# 54 "0_Src/OS/kernel/oo/src/ee_tnterm.c"
void EE_thread_not_terminated(void)
{
  register EE_TID current;
  ...
  current = EE_stk_queryfirst();
# 72 "0_Src/OS/kernel/oo/src/ee_tnterm.c"
  ((void)0);
  ((void)0);
