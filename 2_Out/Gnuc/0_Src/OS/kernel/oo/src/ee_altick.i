# 1 "0_Src/OS/kernel/oo/src/ee_altick.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_altick.c"
# 46 "0_Src/OS/kernel/oo/src/ee_altick.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_altick.c" 2
# 63 "0_Src/OS/kernel/oo/src/ee_altick.c"
void EE_oo_alarm_insert(AlarmType AlarmID, TickType increment)
{
...
# 124 "0_Src/OS/kernel/oo/src/ee_altick.c"
  if ((TaskID < 0) || (TaskID >= 14)) {
    ((void)0);
    ((void)0)
                                            ;
    return;
...
# 174 "0_Src/OS/kernel/oo/src/ee_altick.c"
  if ((TaskID < 0) || (TaskID >= 14)) {
    ((void)0);
    ((void)0)
                                                          ;
...
# 207 "0_Src/OS/kernel/oo/src/ee_altick.c"
  if (((EE_th_event_waitmask[TaskID] & Mask) != 0U) &&
      (EE_th_status[TaskID] == ((EE_UREG)1U)))
  {
...
# 329 "0_Src/OS/kernel/oo/src/ee_altick.c"
StatusType EE_oo_IncrementCounterHardware(CounterType CounterID)
{
  ...
  if(EE_hal_get_IRQ_nesting_level() == 0U) {
    ...
    return ((StatusType)5U);
  }

  if ((CounterID < 0) && (CounterID >= 0)) {
    ((void)0);
...
StatusType EE_oo_IncrementCounter(CounterType CounterID)
{
  ...
  if(EE_oo_check_disableint_error()) {
    ((void)0);
# 392 "0_Src/OS/kernel/oo/src/ee_altick.c"
    ((void)0);

    return ((StatusType)13U);
  }
  ...
  if ((CounterID < 0) || (CounterID >= 1)) {
    ((void)0);
# 412 "0_Src/OS/kernel/oo/src/ee_altick.c"
    ((void)0);
