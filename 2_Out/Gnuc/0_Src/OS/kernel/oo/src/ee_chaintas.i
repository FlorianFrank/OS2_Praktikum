# 1 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
# 46 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_chaintas.c" 2
# 64 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
StatusType EE_oo_ChainTask(TaskType TaskID)
{
...
# 136 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
  flag = EE_hal_begin_nested_primitive();
  ...
  if ((TaskID != current) &&
    ...
    return ((StatusType)4U);
  }
# 166 "0_Src/OS/kernel/oo/src/ee_chaintas.c"
    {
