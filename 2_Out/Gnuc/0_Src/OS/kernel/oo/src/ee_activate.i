# 1 "0_Src/OS/kernel/oo/src/ee_activate.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_activate.c"
# 46 "0_Src/OS/kernel/oo/src/ee_activate.c"
...
# 47 "0_Src/OS/kernel/oo/src/ee_activate.c" 2
# 60 "0_Src/OS/kernel/oo/src/ee_activate.c"
StatusType EE_oo_ActivateTask(TaskType TaskID)
{
  register EE_FREG flag;

  ((void)0);
# 87 "0_Src/OS/kernel/oo/src/ee_activate.c"
  ...
  EE_th_rnact[TaskID]--;
# 136 "0_Src/OS/kernel/oo/src/ee_activate.c"
