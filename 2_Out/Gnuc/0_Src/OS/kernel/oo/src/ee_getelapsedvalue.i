# 1 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c"
# 45 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c"
...
# 46 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c" 2
# 54 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c"
StatusType EE_oo_GetElapsedValue(CounterType CounterID, TickRefType Value,
    TickRefType ElapsedValue)
{
  ...
  if(Value != (TickRefType)0) {
    ...
    if(*Value > EE_counter_ROM[CounterID].maxallowedvalue) {
      ...
      return ((StatusType)8U);
    }
# 119 "0_Src/OS/kernel/oo/src/ee_getelapsedvalue.c"
    if(ElapsedValue != (TickRefType)0) {
