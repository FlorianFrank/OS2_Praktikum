# 1 "0_Src/0_AppSw/Rtc/Mcp79411.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Rtc/Mcp79411.c"
# 11 "0_Src/0_AppSw/Rtc/Mcp79411.c"
...
# 12 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 49 "./0_Src/4_McHal/Tricore/Scu/Std/IfxScuWdt.h"
...
# 13 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 14 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 15 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 16 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 17 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 18 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
...
# 19 "0_Src/0_AppSw/Rtc/Mcp79411.c" 2
# 42 "0_Src/0_AppSw/Rtc/Mcp79411.c"
typedef struct
{
    uint8 i2cTxBuffer[12];
    uint8 i2cRxBuffer[12];
} AppI2c_RTC_Buffer;


typedef struct
{
    AppI2c_RTC_Buffer i2cBuffer;
    struct
    {
     IfxI2c_I2c i2cHandle;
     IfxI2c_I2c_Device i2cDevRtc;
     IfxI2c_I2c_Device i2cDevEeprom;
    }drivers;
} App_I2c_RTC_Cpu;
# 77 "0_Src/0_AppSw/Rtc/Mcp79411.c"
#pragma section ".bss_cpu1" awc1
# 101 "0_Src/0_AppSw/Rtc/Mcp79411.c"
App_I2c_RTC_Cpu g_I2c_RTC_Cpu;
...
#pragma section
# 125 "0_Src/0_AppSw/Rtc/Mcp79411.c"
const IfxI2c_Pins rtc_pins = {&IfxI2c0_SCL_P15_4_INOUT,
...
sint32 rtc_init (void)
{
...

    {
     ...
     i2cDeviceConfig.deviceAddress = 0x6F<<1;

     IfxI2c_I2c_initDevice(&g_I2c_RTC_Cpu.drivers.i2cDevRtc, &i2cDeviceConfig);

     i2cDeviceConfig.deviceAddress = 0x57<<1;

     IfxI2c_I2c_initDevice(&g_I2c_RTC_Cpu.drivers.i2cDevEeprom, &i2cDeviceConfig);


        IfxSrc_init(&((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[0], 1, 128);
        IfxSrc_enable(&((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[0]);

        IfxScuEru_initReqPin(&IfxScu_REQ8_P33_7_IN, IfxPort_InputMode_pullDown);
        IfxScuEru_enableRisingEdgeDetection(IfxScu_REQ8_P33_7_IN.channelId);

        IfxScuEru_connectTrigger(IfxScu_REQ8_P33_7_IN.channelId, IfxScuEru_InputNodePointer_0);
        IfxScuEru_enableTriggerPulse(IfxScu_REQ8_P33_7_IN.channelId);
...
rtc_gettime (TIME *pActTime)
{
 ...
 while(IfxI2c_I2c_read(&g_I2c_RTC_Cpu.drivers.i2cDevRtc, &g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[0], 8) == IfxI2c_I2c_Status_nak);
    ...
    if(g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[3] & 0x20)
        pActTime->flags.B.running = 1;
    else
        pActTime->flags.B.running = 0;

    pActTime->seconds = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[0] & 0x7F;
    pActTime->minutes = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[1] & 0x7F;


    if(g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[2] & 0x40)
    {
        pActTime->flags.B.hour_12 = 1;
        pActTime->hours = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[2] & 0x1F;


        if(g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[2] & 0x20)
        {
    ...
    {
        pActTime->hours = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[2] & 0x3F;
        pActTime->flags.B.hour_12 = 0;
        pActTime->flags.B.pm_set = 0;

    }

    pActTime->day = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[3] & 0x7;
    pActTime->date = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[4] & 0x3F;
    pActTime->month = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[5] & 0x1F;
    pActTime->year = g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[6];


    if((g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[5] & 0x20) == 0x20)
        pActTime->flags.B.leap_year = 1;
    else
        pActTime->flags.B.leap_year = 0;


    if(g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[7] & 0x10)
        pActTime->flags.B.alarm0 = 1;
    else
        pActTime->flags.B.alarm0 = 0;

    if(g_I2c_RTC_Cpu.i2cBuffer.i2cRxBuffer[7] & 0x20)
...
rtc_getalarm (TIME *pActTime, uint8 ucAlarmNumber)
{
    ...
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[0] = 0x0A + ucAlarmNumber*7;
...
# 330 "0_Src/0_AppSw/Rtc/Mcp79411.c"
sint32
rtc_settime (TIME *pActTime)
{

    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[0] = 0x00;

    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[1] = pActTime->seconds | 0x80;
    ...
    if (rtc_cal_sign == 1) g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[2] |= 0x80;
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[4] = pActTime->day | 0x8;
    ...
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[8] = (pActTime->flags.B.alarm0 << 4) | (pActTime->flags.B.alarm1 << 5) | 0x80;
...
uint8 rtc_read_register(uint8 register_number)
{
    ...
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[0] = register_number;
...
void rtc_write_register(uint8 register_number, uint8 value)
{
    ...
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[0] = register_number;
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[1] = value;
...
rtc_alarm_onoff (uint8 ucAlarmNumber, uint8 ucOn)
{
    ...
    alarm_state = alarm >> (4 + ucAlarmNumber);
    alarm_state &= 1;
...
rtc_reset_alarmflag (uint8 ucAlarmNumber)
{
    ...
    alarmflags = rtc_read_register(0x0D + ucAlarmNumber * 7);
...
{
    g_I2c_RTC_Cpu.i2cBuffer.i2cTxBuffer[0] = 0xF0;
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""Calibration_measurement_finished"",""0"",""5" );extern void __attribute__ ((interrupt_handler)) Calibration_measurement_finished(); void Calibration_measurement_finished (void)
{
    float32 rtc_freq;
    Ifx_GTM *psGTM;
    uint32 actualPeriod;
    ...
    psGTM = &((*(Ifx_GTM *)0xF0100000u));
    __asm__ volatile ("enable" : : : "memory");

    if (rtc_calibration_finished != 1)
    {
        ...
        newCalValue = (sint8)(((((32768.0f-rtc_freq)/2.0f) - (sint32)((32768.0f-rtc_freq)/2.0f)) > 0.5) ? (1 + (sint32)((32768.0f-rtc_freq)/2.0f)) : ((sint32)((32768.0f-rtc_freq)/2.0f)));
        rtc_calibration_finished = 1;
    }
    else
    {
    ...
    IfxSrc_disable(&((*(Ifx_SRC *)0xF0038000u)).GTM.GTM[0].TIM[0][3]);

    IfxGtm_Cmu_enableClocks(&((*(Ifx_GTM *)0xF0100000u)), (0x00000004));

    IfxSrc_clearRequest(&((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[0]);
    IfxSrc_enable(&((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[0]);
}
...
rtc_calibration (void)
{
    ...
    IfxSrc_disable(&((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[0]);

    saved_control_register = rtc_read_register(0x03);

    if ((saved_control_register & 0x20) != 0x20) rtc_write_register(0x00, rtc_read_register(0x00) | 0x80);
    ...
    IfxGtm_Cmu_setClkFrequency(&((*(Ifx_GTM *)0xF0100000u)), IfxGtm_Cmu_Clk_1, 10000000.0f);
    IfxGtm_Cmu_enableClocks(&((*(Ifx_GTM *)0xF0100000u)), (0x00000008));

    psGTM->INOUTSEL.TIM[0].INSEL.B.CH3SEL = 0x9;
    psGTM->TIM[0].CH3.CTRL.B.TIM_MODE = IfxGtm_Tim_Mode_pwmMeasurement;
    psGTM->TIM[0].CH3.CTRL.B.GPR0_SEL = IfxGtm_Tim_GprSel_cnts;
    psGTM->TIM[0].CH3.CTRL.B.GPR1_SEL = IfxGtm_Tim_GprSel_cnts;
    psGTM->TIM[0].CH3.CTRL.B.CLK_SEL = 1;
    psGTM->TIM[0].CH3.CTRL.B.OSM = 1;
    psGTM->TIM[0].CH3.IRQ_EN.B.NEWVAL_IRQ_EN = 1;

    IfxSrc_init(&((*(Ifx_SRC *)0xF0038000u)).GTM.GTM[0].TIM[0][3], 1, 5);
    IfxSrc_enable(&((*(Ifx_SRC *)0xF0038000u)).GTM.GTM[0].TIM[0][3]);
