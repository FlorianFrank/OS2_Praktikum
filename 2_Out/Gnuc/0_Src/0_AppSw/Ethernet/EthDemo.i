# 1 "0_Src/0_AppSw/Ethernet/EthDemo.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Ethernet/EthDemo.c"
# 28 "0_Src/0_AppSw/Ethernet/EthDemo.c"
...
# 29 "0_Src/0_AppSw/Ethernet/EthDemo.c" 2
...
# 38 "0_Src/0_AppSw/Ethernet/EthDemo.h" 2
...
# 30 "0_Src/0_AppSw/Ethernet/EthDemo.c" 2
# 47 "0_Src/0_AppSw/Ethernet/EthDemo.c"
App_Eth g_Eth;
# 57 "0_Src/0_AppSw/Ethernet/EthDemo.c"
const uint8 myMacAddress[6] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55};
# 72 "0_Src/0_AppSw/Ethernet/EthDemo.c"
...
void EthDemo_transmit(App_Eth *Ethernet,uint32 packetSize,uint8 *destinationAddress, uint8 *data)
{
 ...
 if(pTxBuf!=((void *)0))
 {
  ...
  IfxEth_sendTransmitBuffer(&g_Eth.drivers.eth, 14 + packetSize);
 }
}
...
uint8 EthDemo_receive(App_Eth *Ethernet,uint32 *packetSize,uint8 *sourceAddress, uint8 *data)
{
 uint8 *pRxBuf = (uint8 *)IfxEth_getReceiveBuffer(&g_Eth.drivers.eth);
 uint8 errors = 0;
 uint32 i;
