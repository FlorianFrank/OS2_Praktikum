# 1 "0_Src/0_AppSw/appTft/menue.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/menue.c"
# 10 "0_Src/0_AppSw/appTft/menue.c"
...
# 11 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 12 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 13 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 14 "0_Src/0_AppSw/appTft/menue.c" 2
# 1 "./0_Src/0_AppSw/Tft/touch.h" 1
# 11 "./0_Src/0_AppSw/Tft/touch.h"
...
# 12 "./0_Src/0_AppSw/Tft/touch.h" 2
...
# 15 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 16 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 17 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 18 "0_Src/0_AppSw/appTft/menue.c" 2
...
# 19 "0_Src/0_AppSw/appTft/menue.c" 2
# 31 "0_Src/0_AppSw/appTft/menue.c"
...
{(7 << 4) | 0, (0 << 4) | 12, 7, 31, 0, &menu_select_time, &menu_display_time, &menu_input,"Date: 24/10/14 Time: 16:00"},
{0, 0, 0, 0, 0, 0, 0, 0, " "},
{(7 << 4) | 0, (0 << 4) | 12, 0, 12, 2, &menu_select_menu1, &menu_display, &menu_input,"TFT Main Menu"},
{(7 << 4) | 0, (0 << 4) | 12, 0, 5, 3, &menu_display_menu2, &menu_display_menu2, &menu_input,"Menu_2"},
{(7 << 4) | 0, (0 << 4) | 12, 0, 5, 4, &menu_display_menu2, &menu_display_menu2, &menu_input,"Menu_2"},



{(7 << 4) | 0, (0 << 4) | 12, 0, 8, 5, &menu_select_alarm, &menu_display, &menu_input,"Set Alarm"},

{(7 << 4) | 0, (0 << 4) | 12, 0, 16,7, &menu_select_background_light, &menu_display_background_light, &menu_input_background_light, "Background Light: "},
{(7 << 4) | 0, (0 << 4) | 12, 0, 15,8, &menu_select_background_lightplus, &menu_display, &menu_input, "----> Increase: +"},
{(7 << 4) | 0, (0 << 4) | 12, 0, 15,9, &menu_select_background_lightminus, &menu_display, &menu_input, "----> Decrease: -"},

{(7 << 4) | 0, (0 << 4) | 12, 0, 15,11, &menu_select_die_temp, &menu_display_die_temp, &menu_input, "DIE-Temperature: "},

{(7 << 4) | 0, (0 << 4) | 12, 0, 13,13, &menu_select_core_volt, &menu_display_core_volt, &menu_input, "Core Voltage : "},
{(7 << 4) | 0, (0 << 4) | 12, 0, 13,14, &menu_select_Vddp3, &menu_display_Vddp3, &menu_input, "VDDP3 Voltage: "},
{(7 << 4) | 0, (0 << 4) | 12, 0, 13,15, &menu_select_Vext, &menu_display_Vext, &menu_input, "VEXT Voltage : "},

{(7 << 4) | 0, (0 << 4) | 12, 0, 13,17, &menu_select_slideshow, &menu_display_slideshow, &menu_input, "Start Slideshow"},
...
void menu_select_alarm (sint32 ind, TDISPLAYENTRY * pdisplayentry)
{
    ...
    if ((touch_driver.touchmode & 0x8) != 0)
    {
      conio_driver.dialogmode = SETALARMTIME;
      rtc_gettime (&Time2Set);
      touch_driver.touchmode &= ~0x8;
    }
}
...
{
    conio_ascii_textattr (DISPLAYMENU, pdisplayentry->color_select);
    conio_ascii_printfxy (DISPLAYMENU, pdisplayentry->xmin, pdisplayentry->y, (const uint8 *)"Change Light: %u", (unsigned int) backgroundlightsize);
    if ((touch_driver.touchmode & 0x8) != 0)
    {
...
void menu_display_slideshow (sint32 ind, TDISPLAYENTRY * pdisplayentry)
{
 if (IfxPort_getPinState(&((*(Ifx_P *)0xF003B500u)), 8) == 1)
 {

  conio_ascii_textattr (DISPLAYMENU, 8);
  conio_ascii_textbackground (DISPLAYMENU, 5);
 }
 else
  conio_ascii_textattr (DISPLAYMENU, pdisplayentry->color_display);
    conio_ascii_gotoxy (DISPLAYMENU, pdisplayentry->xmin, pdisplayentry->y);
...
void showmenu (sint16 x, sint16 y, TDISPLAYENTRY * pmenulist)
{
    ...
    conio_ascii_textcolor (DISPLAYMENU, 0);
    conio_ascii_textbackground (DISPLAYMENU, 7);
