# 1 "0_Src/0_AppSw/appTft/basebar.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/basebar.c"
# 9 "0_Src/0_AppSw/appTft/basebar.c"
...
# 10 "0_Src/0_AppSw/appTft/basebar.c" 2
...
# 11 "0_Src/0_AppSw/appTft/basebar.c" 2
...
# 12 "0_Src/0_AppSw/appTft/basebar.c" 2
# 24 "0_Src/0_AppSw/appTft/basebar.c"
...
# 39 "0_Src/0_AppSw/appTft/basebar.c"
const TDISPLAYENTRY stdlist[6] = {
  {(7 << 4) | 0, (0 << 4) | 12, 0, 6, ((240/12)-1), &bar_select_menu, 0, &bar_input, " iMENU "},
  {(7 << 4) | 0, (0 << 4) | 12, 8, 16, ((240/12)-1), &bar_select_stdout0, 0, &bar_input, " STDOUT0 "},
  {(7 << 4) | 0, (0 << 4) | 12, 18, 26, ((240/12)-1), &bar_select_stdout1, 0, &bar_input, " STDOUT1 "},
  {(7 << 4) | 0, (0 << 4) | 12, 28, 35, ((240/12)-1), &bar_select_graph0, 0, &bar_input, " GRAPH0 "},
  {(7 << 4) | 0, (0 << 4) | 12, 37, 40, ((240/12)-1), &bar_select_off, 0, &bar_input, "OFF"},
  {0, 0, 0, 0, 0, 0, 0, 0, " "}
};
...
void bar_select_off (sint32 ind, TDISPLAYENTRY * pdisplayentry)
{
    ...
    if ((touch_driver.touchmode & 0x8) != 0)
    {
        conio_driver.dialogmode = SWITCHOFFON;
