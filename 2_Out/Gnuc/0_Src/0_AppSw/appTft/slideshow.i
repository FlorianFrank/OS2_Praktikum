# 1 "0_Src/0_AppSw/appTft/slideshow.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/slideshow.c"
# 10 "0_Src/0_AppSw/appTft/slideshow.c"
...
# 11 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 12 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 13 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 14 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 15 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 16 "0_Src/0_AppSw/appTft/slideshow.c" 2
...
# 17 "0_Src/0_AppSw/appTft/slideshow.c" 2
# 25 "0_Src/0_AppSw/appTft/slideshow.c"
...
# 53 "0_Src/0_AppSw/appTft/slideshow.c"
FATFS Fatfs;
FIL actFile;
FILINFO fno;
DIR dir;
BITMAPFILEHEADER actFileHeader;
BITMAPINFOHEADER actInfoHeader;
uint32 uiActRow;
uint8 rawRowData[320*3];
# 76 "0_Src/0_AppSw/appTft/slideshow.c"
extern uint16 Row_Buff[];
...
void start_slideshow (void)
{
    ...
    IfxPort_setPinModeOutput(IfxGtm_TOM1_1_TOUT69_P20_13_OUT.pin.port, IfxGtm_TOM1_1_TOUT69_P20_13_OUT.pin.pinIndex, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
    IfxPort_setPinState(IfxGtm_TOM1_1_TOUT69_P20_13_OUT.pin.port, IfxGtm_TOM1_1_TOUT69_P20_13_OUT.pin.pinIndex, IfxPort_State_high);

 IfxPort_setPinModeInput(IfxPort_P13_3.port, IfxPort_P13_3.pinIndex, IfxPort_Mode_inputPullUp);
...
void slideshow_periodic (void)
{
 ...
 if (actFile.fs == 0)
 {
  ...
  if ((fno.fname[0] == '.') || (fno.fattrib & 0x10)) return;
  if (fno.lfname == 0) fno.lfname = fno.fname;
  res = f_open(&actFile, fno.lfname, 0x01);
  if (res != FR_OK)
  {
 ...
 if (uiActRow < 240)
 {
  for (usCnt=0;usCnt<320; usCnt++) Row_Buff[usCnt] = 0;
  tft_display_setxy(0, uiActRow);
  if (uiActRow < actInfoHeader.biHeight)
  {

   res = f_read(&actFile, (void *)&rawRowData, 320*(actInfoHeader.biBitCount/8) , &bytesRead);
   if ((res != FR_OK) || (bytesRead != 320*(actInfoHeader.biBitCount/8)))
   {
   ...
   for (usCnt=0;usCnt<320; usCnt++)
   {
    if (actInfoHeader.biBitCount == 24)
    {
     uint8 r,g,b;

     b = rawRowData[(actInfoHeader.biBitCount/8)*usCnt] >> 3;
     g = rawRowData[(actInfoHeader.biBitCount/8)*usCnt+1] >> 2;
     r = rawRowData[(actInfoHeader.biBitCount/8)*usCnt+2] >> 3;
