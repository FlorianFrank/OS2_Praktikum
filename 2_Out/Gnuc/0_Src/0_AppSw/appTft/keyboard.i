# 1 "0_Src/0_AppSw/appTft/keyboard.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/keyboard.c"
# 12 "0_Src/0_AppSw/appTft/keyboard.c"
...
# 13 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 14 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 15 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 16 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 17 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 18 "0_Src/0_AppSw/appTft/keyboard.c" 2
...
# 19 "0_Src/0_AppSw/appTft/keyboard.c" 2
# 36 "0_Src/0_AppSw/appTft/keyboard.c"
...
{(7 << 4) | 0, (0 << 4) | 12, 25, 25, 11, &keyboard_select, &keyboard_display, &keyboard_input, "Ü",'Ü'},
...
{(7 << 4) | 0, (0 << 4) | 12, 24, 24, 13, &keyboard_select, &keyboard_display, &keyboard_input, "Ö",'Ö'},
{(7 << 4) | 0, (0 << 4) | 12, 26, 26, 13, &keyboard_select, &keyboard_display, &keyboard_input, "Ä",'Ä'},
...
# 139 "0_Src/0_AppSw/appTft/keyboard.c"
void keyboard_display (sint32 ind, TDISPLAYENTRY * pdisplayentry)
{
    sint32 j;
...
void keyboard (sint16 x, sint16 y)
{
    ...
    conio_ascii_textchangebackground (DISPLAYMENU, 2);
    for (i = 0; i < 61; i += 1)
    {
