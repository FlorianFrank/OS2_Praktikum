# 1 "0_Src/0_AppSw/appTft/showalarm.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/showalarm.c"
# 12 "0_Src/0_AppSw/appTft/showalarm.c"
...
# 13 "0_Src/0_AppSw/appTft/showalarm.c" 2
...
# 14 "0_Src/0_AppSw/appTft/showalarm.c" 2
...
# 15 "0_Src/0_AppSw/appTft/showalarm.c" 2
...
# 17 "0_Src/0_AppSw/appTft/showalarm.c" 2
...
# 18 "0_Src/0_AppSw/appTft/showalarm.c" 2
# 31 "0_Src/0_AppSw/appTft/showalarm.c"
...
const TDISPLAYENTRY showalarmlist[2] = {
{(2 << 4) | 0, (0 << 4) | 12, 9, 17, 10, &showalarm_select_reset, &showalarm_display, &showalarm_input,"", 0x0},
{(2 << 4) | 0, (0 << 4) | 12, 23, 30, 10, &showalarm_select_ignore, &showalarm_display, &showalarm_input,"", 0x0}
};
...
void showalarm (sint16 x, sint16 y)
{
    ...
    {
     conio_ascii_textbackground (DISPLAYMENU, 2);
        beeper_on();
    }
    else
    {
     conio_ascii_textbackground (DISPLAYMENU, 10);
        beeper_off();
    }
    for (j = 0; j < 9; j += 1)
    {
