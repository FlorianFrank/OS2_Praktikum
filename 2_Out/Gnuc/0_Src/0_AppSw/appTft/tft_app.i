# 1 "0_Src/0_AppSw/appTft/tft_app.c"
...
# 6 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 7 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 8 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 9 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 10 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 13 "0_Src/0_AppSw/appTft/tft_app.c" 2
...
# 35 "0_Src/0_AppSw/appTft/tft_app.c"
...
# 67 "0_Src/0_AppSw/appTft/tft_app.c"
#pragma section ".bss_cpu1" awc1
# 91 "0_Src/0_AppSw/appTft/tft_app.c"
...
#pragma section
# 126 "0_Src/0_AppSw/appTft/tft_app.c"
extern volatile boolean tft_ready;



const TCONIODLGENTRY conio_dialog_list[5] =
{
    { KEYBOARDON, &keyboard },
...
const TCONIODMENTRY conio_displaymode_list[5] =
{
    { DISPLAYBAR, {(uint8 *) & display_bar, (uint8 *) & displaycolor_bar, TEXTMODE, 1, (320/8), 1, 0, 0} },
    { DISPLAYMENU, {(uint8 *) & display_menu, (uint8 *) & displaycolor_menu, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAYSTDOUT0, {(uint8 *) & display_stdout0, (uint8 *) & displaycolor_stdout0, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAYSTDOUT1, {(uint8 *) & display_stdout1, (uint8 *) & displaycolor_stdout1, TEXTMODE, 1, (320/8), (240/12)-1, 0, 0} },
    { DISPLAYGRAPHICS0, {(uint8 *) & display_graphics0, 0, GRAPHICMODE_16COLOR, 1, (320/8), (240/12), 0, 0} }
};
# 156 "0_Src/0_AppSw/appTft/tft_app.c"
void tft_appl_init (uint8 RtcRunning)
{

    IfxSrc_init(&((*(Ifx_SRC *)0xF0038000u)).GPSR.GPSR[0].SR0, 1, 2);
    IfxSrc_enable(&((*(Ifx_SRC *)0xF0038000u)).GPSR.GPSR[0].SR0);


    if (IfxPort_getPinState(IfxScu_REQ8_P33_7_IN.pin.port,IfxScu_REQ8_P33_7_IN.pin.pinIndex) == 1) conio_driver.dialogmode = SHOWALARMON;
    ...
    if (IfxPort_getPinState(IfxPort_P15_8.port, IfxPort_P15_8.pinIndex) == 0)
 {
