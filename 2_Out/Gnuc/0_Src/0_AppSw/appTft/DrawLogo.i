# 1 "0_Src/0_AppSw/appTft/DrawLogo.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/appTft/DrawLogo.c"
# 11 "0_Src/0_AppSw/appTft/DrawLogo.c"
...
# 12 "0_Src/0_AppSw/appTft/DrawLogo.c" 2
...
# 13 "0_Src/0_AppSw/appTft/DrawLogo.c" 2
# 26 "0_Src/0_AppSw/appTft/DrawLogo.c"
const uint8 infineon_logo[1962] = {
        ...
        0x9B, 0xFF, 0x23, 0x2,
        0x50, 0xFF };
# 124 "0_Src/0_AppSw/appTft/DrawLogo.c"
void graph_drawInfineonLogo(void)
{
    ...
    for(i = 0; i < 240 - 12; i++)
    {
        for(j = 0; j < 320; j++)
        {
            conio_graphics_set(DISPLAYGRAPHICS0, j, i, 2);
        }
    }
    ...
    for(i = 5; i < 240 - 12 - 5; i++)
    {
        for(j = 5; j < 320 - 5; j++)
        {
            conio_graphics_set(DISPLAYGRAPHICS0, j, i, 5);
        }
    }
    ...
    for(i = 10; i < 240 - 12 - 10; i++)
    {
        for(j = 10; j < 320 - 10; j++)
        {
            conio_graphics_set(DISPLAYGRAPHICS0, j, i, 1);
        }
    }
