# 1 "0_Src/0_AppSw/Power/TLF35584.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Power/TLF35584.c"
# 28 "0_Src/0_AppSw/Power/TLF35584.c"
# 1 "0_Src/0_AppSw/Power/TLF35584.h" 1
# 35 "0_Src/0_AppSw/Power/TLF35584.h"
...
# 36 "0_Src/0_AppSw/Power/TLF35584.h" 2
...
# 29 "0_Src/0_AppSw/Power/TLF35584.c" 2
# 44 "0_Src/0_AppSw/Power/TLF35584.c"
typedef struct
{
...
# 101 "0_Src/0_AppSw/Power/TLF35584.c"
App_Qspi_TLF_Cpu g_Qspi_TLF_Cpu;
boolean TLF_A_Step;


#pragma section
# 130 "0_Src/0_AppSw/Power/TLF35584.c"
void IfxTLF35584_init(void)
{

    boolean interruptState = IfxCpu_disableInterrupts();

    g_Qspi_TLF_Cpu.drivers.spiMaster = qspi2_init();
 ...
 g_Qspi_TLF_Cpu.qspiBuffer.spiTxBuffer[0] = 0;
    ...
    IfxTLF35584_read_write(0x6801);

    if ((IfxTLF35584_read_write(0x3E01)>>1) & 0x4)
    {


        IfxTLF35584_read_write(0xBE09);
     TLF_A_Step = 0;
    }
    else
     TLF_A_Step = 1;
...
void IfxTLF35584_unprotect_register(void)
{
    IfxTLF35584_read_write(0x8756);
    IfxTLF35584_read_write(0x87DE);
    IfxTLF35584_read_write(0x86AD);
    IfxTLF35584_read_write(0x8625);
}

void IfxTLF35584_protect_register(void)
{
    IfxTLF35584_read_write(0x87BE);
    IfxTLF35584_read_write(0x8668);
    IfxTLF35584_read_write(0x877D);
    IfxTLF35584_read_write(0x8795);
}
...
void IfxTLF35584_disable_window_watchdog(void)
{
    ...
    if (TLF_A_Step == 1)
        uiWdcfg0 = IfxTLF35584_read_write(0x0C00);
    else
        uiWdcfg0 = IfxTLF35584_read_write(0x1A00);
...
void IfxTLF35584_disable_err_pin_monitor(void)
{
    ...
    else
    {
     ...
     uiSyspcfg = IfxTLF35584_read_write(0x1800);
...
{
    if (TLF_A_Step == 1)
        IfxTLF35584_read_write(0x9DD9);
    else
    {
        IfxTLF35584_read_write(0xABD9);
        IfxTLF35584_read_write(0xAC27);
    }
}
...
void IfxTLF35584_goto_normal_state(void)
{
    ...
    if (TLF_A_Step == 1)
        IfxTLF35584_read_write(0x9DD5);
    else
    {
        IfxTLF35584_read_write(0xABD5);
        IfxTLF35584_read_write(0xAC2B);
    }
}
...
uint32 IfxTLF35584_read_write(uint32 send_data)
{
    ...
    IfxQspi_SpiMaster_exchange(&g_Qspi_TLF_Cpu.drivers.spiMasterChannel, &g_Qspi_TLF_Cpu.qspiBuffer.spiTxBuffer[0],
        &g_Qspi_TLF_Cpu.qspiBuffer.spiRxBuffer[0], 1);
