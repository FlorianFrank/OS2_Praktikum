...
.intr.entry.include:                                
.endif                                              
.intr.entry ISR_qspi3_Er,0,13
#NO_APP
	.align 1
	.global	ISR_qspi3_Tx
	.type	ISR_qspi3_Tx, @function
ISR_qspi3_Tx:
.LFB334:
	.file 1 "0_Src/0_AppSw/Qspi/Qspi3.c"
	.loc 1 125 0
.LBB22:
.LBB23:
...
.LBE22:
	.loc 1 130 0
	movh.a	%a4, hi:spi3Master
	lea	%a4, [%a4] lo:spi3Master
	call	IfxQspi_SpiMaster_isrTransmit
.LVL0:
	rslcx
	rfe
.LFE334:
	.size	ISR_qspi3_Tx, .-ISR_qspi3_Tx
	.align 1
	.global	ISR_qspi3_Rx
	.type	ISR_qspi3_Rx, @function
ISR_qspi3_Rx:
.LFB335:
	.loc 1 146 0
.LBB24:
...
.LVL1:
	...
	rfe
.LFE335:
	.size	ISR_qspi3_Rx, .-ISR_qspi3_Rx
	.align 1
	.global	ISR_qspi3_Er
	.type	ISR_qspi3_Er, @function
ISR_qspi3_Er:
.LFB336:
	.loc 1 165 0
.LBB26:
...
.LVL2:
	...
	rfe
.LFE336:
	.size	ISR_qspi3_Er, .-ISR_qspi3_Er
	.align 1
	.global	qspi3_init
	.type	qspi3_init, @function
qspi3_init:
.LFB337:
	.loc 1 175 0
	sub.a	%SP, 72
...
.LBE28:
	.loc 1 182 0
	movh.a	%a2, hi:spi3Master
	lea	%a2, [%a2] lo:spi3Master
	ld.w	%d8, [%a2] 40
	jz	%d8, .L11
.L5:
.LVL5:
...
.LVL6:
	...
	mov.aa	%a4, %a2
	.loc 1 208 0
	movh.a	%a15, hi:IfxQspi3_MRSTA_P02_5_IN
	.loc 1 191 0
	st.h	[%SP] 14, %d2
	.loc 1 192 0
	mov	%d2, 50
	.loc 1 208 0
	lea	%a15, [%a15] lo:IfxQspi3_MRSTA_P02_5_IN
	.loc 1 194 0
	st.w	[%SP] 20, %d8
	.loc 1 192 0
	st.h	[%SP] 12, %d2
	...
	st.h	[%SP] 16, %d2
	.loc 1 202 0
	movh	%d2, hi:qspi3_pins
	addi	%d2, %d2, lo:qspi3_pins
	st.w	[%SP] 56, %d2
	.loc 1 205 0
...
.LVL8:
	...
	j	.L5
.LFE337:
	.size	qspi3_init, .-qspi3_init
	.global	qspi3_pins
.section .rodata,"a",@progbits
	.align 2
	.type	qspi3_pins, @object
	.size	qspi3_pins, 28
qspi3_pins:
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/0_AppSw/Qspi/Qspi3.c"
...
.LASF50:
	.string	"SHADR"
	.extern	IfxQspi3_MTSR_P02_6_OUT,STT_OBJECT,16
	.extern	IfxQspi3_SCLK_P02_7_OUT,STT_OBJECT,16
	.extern	IfxPort_setPinPadDriver,STT_FUNC,0
	.extern	IfxQspi_SpiMaster_initModule,STT_FUNC,0
	.extern	IfxQspi3_MRSTA_P02_5_IN,STT_OBJECT,16
