...
ISR_qspi2_Tx:
.LFB334:
	.file 1 "0_Src/0_AppSw/Qspi/Qspi2.c"
	.loc 1 125 0
.LBB22:
.LBB23:
...
.LBE22:
	.loc 1 130 0
	movh.a	%a4, hi:spi2Master
	lea	%a4, [%a4] lo:spi2Master
...
.LBE28:
	.loc 1 182 0
	movh.a	%a2, hi:spi2Master
	lea	%a2, [%a2] lo:spi2Master
	ld.w	%d8, [%a2] 40
	jz	%d8, .L11
.L5:
.LVL5:
...
.LVL6:
	...
	mov.aa	%a4, %a2
	.loc 1 208 0
	movh.a	%a15, hi:IfxQspi2_MRSTB_P15_7_IN
	.loc 1 191 0
	st.h	[%SP] 14, %d2
	.loc 1 192 0
	mov	%d2, 53
	.loc 1 208 0
	lea	%a15, [%a15] lo:IfxQspi2_MRSTB_P15_7_IN
	.loc 1 194 0
	st.w	[%SP] 20, %d8
	.loc 1 192 0
	st.h	[%SP] 12, %d2
	...
	st.h	[%SP] 16, %d2
	.loc 1 202 0
	movh	%d2, hi:qspi2_pins
	addi	%d2, %d2, lo:qspi2_pins
	st.w	[%SP] 56, %d2
	.loc 1 205 0
...
.LVL8:
	...
	j	.L5
.LFE337:
	.size	qspi2_init, .-qspi2_init
	.global	qspi2_pins
.section .rodata,"a",@progbits
	.align 2
	.type	qspi2_pins, @object
	.size	qspi2_pins, 28
qspi2_pins:
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/0_AppSw/Qspi/Qspi2.c"
...
.LASF50:
	.string	"SHADR"
	.extern	IfxQspi2_MTSR_P15_6_OUT,STT_OBJECT,16
	.extern	IfxQspi2_SCLK_P15_3_OUT,STT_OBJECT,16
	.extern	IfxPort_setPinPadDriver,STT_FUNC,0
	.extern	IfxQspi_SpiMaster_initModule,STT_FUNC,0
	.extern	IfxQspi2_MRSTB_P15_7_IN,STT_OBJECT,16
