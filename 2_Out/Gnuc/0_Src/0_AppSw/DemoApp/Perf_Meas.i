# 1 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
...
# 9 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
...
# 10 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
...
# 1027 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h"
typedef volatile struct _Ifx_CBS_TRTGB
{
    Ifx_CBS_TRTGB_L L;
    Ifx_CBS_TRTGB_H H;
} Ifx_CBS_TRTGB;
# 1044 "./0_Src/4_McHal/Tricore/_Reg/IfxCbs_regdef.h"
...
# 11 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
...
# 12 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
...
# 1 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h" 1
# 52 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h"
# 1 "./0_Src/SrvSw/StdIf/IfxStdIf.h" 1
# 97 "./0_Src/SrvSw/StdIf/IfxStdIf.h"
typedef void *IfxStdIf_InterfaceDriver;
# 53 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h" 2
...
# 135 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h"
typedef void (*IfxStdIf_Timer_ApplyUpdate)(IfxStdIf_InterfaceDriver driver);
# 152 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h"
...
# 419 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h"
...
# 15 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
...
# 16 "0_Src/0_AppSw/DemoApp/Perf_Meas.c" 2
# 34 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
#pragma section ".bss_cpu2" awc2
# 44 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
...
# 63 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
...
# 81 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
...
#pragma section
# 97 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
extern volatile boolean tft_ready;
extern App_Cpu g_AppCpu0;
extern App_Cpu g_AppCpu1;
extern App_Cpu g_AppCpu2;
# 111 "0_Src/0_AppSw/DemoApp/Perf_Meas.c"
void perf_meas_init(void)
{
 ...
 IfxGtm_Tom_Timer_Config driverConfig;
    ...
    driverConfig.base.isrProvider = 1;
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""ISR_perf_meas_call"",""0"",""255" );extern void __attribute__ ((interrupt_handler)) ISR_perf_meas_call(); void ISR_perf_meas_call (void)
{
    ...
    if (tft_ready == 1)
    {
     ...
     conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 2, (uint8 *)"CPU0 Load %.3f %c ", cpu_load, 0x25);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 3, (uint8 *)"CPU0 Idle Counter-Diff %.10u ", counter_diff);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 4, (uint8 *)"CPU0 in use for %.3e Cycles/s ", g_AppCpu0.info.cpuFreq/100.0f*cpu_load);
    }
    ...
    {
     if (cpu_load < 0.0f) cpu_load = 0.0f;
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 6, (uint8 *)"CPU1 Load %.3f %c ", cpu_load, 0x25);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 7, (uint8 *)"CPU1 Idle Counter-Diff %.10u ", counter_diff);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 8, (uint8 *)"CPU1 in use for %.3e Cycles/s ", g_AppCpu1.info.cpuFreq/100.0f*cpu_load);
    }
    ...
    {
     if (cpu_load < 0.0f) cpu_load = 0.0f;
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 10, (uint8 *)"CPU2 Load %.3f %c ", cpu_load, 0x25);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 11, (uint8 *)"CPU2 Idle Counter-Diff %.10u ", counter_diff);
        conio_ascii_printfxy (DISPLAYSTDOUT0, 1, 12, (uint8 *)"CPU2 in use for %.3e Cycles/s ", g_AppCpu2.info.cpuFreq/100.0f*cpu_load);
    }
