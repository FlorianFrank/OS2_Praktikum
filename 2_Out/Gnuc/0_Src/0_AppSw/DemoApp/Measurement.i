# 1 "0_Src/0_AppSw/DemoApp/Measurement.c"
...
# 9 "0_Src/0_AppSw/DemoApp/Measurement.c" 2
...
# 10 "0_Src/0_AppSw/DemoApp/Measurement.c" 2
...
# 11 "0_Src/0_AppSw/DemoApp/Measurement.c" 2
...
# 12 "0_Src/0_AppSw/DemoApp/Measurement.c" 2
...
# 14 "0_Src/0_AppSw/DemoApp/Measurement.c" 2
# 32 "0_Src/0_AppSw/DemoApp/Measurement.c"
#pragma section ".bss_cpu0" awc0
# 67 "0_Src/0_AppSw/DemoApp/Measurement.c"
...
#pragma section
# 104 "0_Src/0_AppSw/DemoApp/Measurement.c"
void measurement_init(void)
{
 Ifx_GPT12 * gpt12;
 ...
 gpt12 = &((*(Ifx_GPT12 *)0xF0002E00u));

 IfxGpt12_enableModule(gpt12);
 IfxGpt12_T6_enableClearTimer(gpt12, 0);
 ...
 IfxGpt12_T6_setTimerDirection(gpt12, IfxGpt12_TimerDirection_down);
    ...
    gpt12->CAPREL.B.CAPREL = 50*(uint32)(IfxGpt12_T6_getFrequency(gpt12)/1000.0f);
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""ISR_gtp12_t6"",""0"",""1" );extern void __attribute__ ((interrupt_handler)) ISR_gtp12_t6(); void ISR_gtp12_t6 (void)
{
 ...
 if ((*(volatile Ifx_SCU_EVRADCSTAT *)0xF003619Cu).B.VAL == 1)
 {
  core_voltage = (((*(volatile Ifx_SCU_EVRADCSTAT *)0xF003619Cu).B.ADC13V-1) * 0.0057692f);
  if(core_voltage > core_volt_max)
   core_volt_max = core_voltage;
  if(core_voltage < core_volt_min)
   core_volt_min = core_voltage;

  Vddp3 = (((*(volatile Ifx_SCU_EVRADCSTAT *)0xF003619Cu).B.ADC33V-1) * 0.023077f);
  if(Vddp3 > Vddp3_max)
   Vddp3_max = Vddp3;
  if(Vddp3 < Vddp3_min)
   Vddp3_min = Vddp3;

  Vext = (((*(volatile Ifx_SCU_EVRADCSTAT *)0xF003619Cu).B.ADCSWDV-1) * 0.023077f);
  if(Vext > Vext_max)
   Vext_max = Vext;
  if(Vext < Vext_min)
   Vext_min = Vext;
