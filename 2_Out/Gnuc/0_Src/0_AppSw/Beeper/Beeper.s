...
.Ltext0:
	.align 1
	.global	beeper_init
	.type	beeper_init, @function
beeper_init:
.LFB353:
	.file 1 "0_Src/0_AppSw/Beeper/Beeper.c"
	.loc 1 52 0
	sub.a	%SP, 152
.LCFI0:
	.loc 1 57 0
...
.LVL3:
	...
	ret
.LFE353:
	.size	beeper_init, .-beeper_init
	.align 1
	.global	beeper_on
	.type	beeper_on, @function
beeper_on:
.LFB354:
	.loc 1 87 0
.LVL4:
...
.LBE10:
	...
	ret
.LFE354:
	.size	beeper_on, .-beeper_on
	.align 1
	.global	beeper_off
	.type	beeper_off, @function
beeper_off:
.LFB355:
	.loc 1 99 0
.LVL6:
...
.Letext0:
	...
	.file 12 "./0_Src/SrvSw/StdIf/IfxStdIf_Timer.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/0_AppSw/Beeper/Beeper.c"
