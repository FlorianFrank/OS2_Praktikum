# 1 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c"
# 26 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c"
# 1 "0_Src/0_AppSw/Config/Common/Interrupts_Cfg.h" 1
# 27 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c" 2
...
# 28 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c" 2
...
# 33 "./0_Src/OS/Os.h" 2
# 30 "0_Src/0_AppSw/Config/Common/Stm_Cfg.c" 2
...
void initStm1(void)
{
    Ifx_STM *stm = &((*(Ifx_STM *)0xF0000100u));
    ...
    stmCompareConfig.ticks = IfxStm_getLower(stm) + ((200000000) / 2 / 1000);
