# 1 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
# 26 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
# 1 "0_Src/0_AppSw/Config/Common/Interrupts_Cfg.h" 1
# 27 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c" 2
...
# 1 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h" 1
# 40 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
...
# 41 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h" 2
# 56 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
...
# 75 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean areInterruptsEnabled(void)
{
    return IfxCpu_areInterruptsEnabled();
}
# 88 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean disableInterrupts(void)
{
...
# 122 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) void restoreInterrupts(boolean enabled)
{
    IfxCpu_restoreInterrupts(enabled);
}
# 148 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
extern Ifx_TickTime TimeConst[(11)];
# 157 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
...
# 201 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime now(void)
{
    Ifx_TickTime stmNow;
...
# 220 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime nowWithoutCriticalSection(void)
{
    Ifx_TickTime stmNow;
...
# 237 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime addTTime(Ifx_TickTime a, Ifx_TickTime b)
{
    Ifx_TickTime result;
...
# 260 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime elapsed(Ifx_TickTime since)
{
    return now() - since;
}
# 272 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime getDeadLine(Ifx_TickTime timeout)
{
...
# 295 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime getTimeout(Ifx_TickTime deadline)
{
...
# 319 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean isDeadLine(Ifx_TickTime deadLine)
{
    boolean result;
...
# 344 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) boolean poll(volatile boolean *test, Ifx_TickTime timeout)
{
...
# 366 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime timingNoInterruptEnd(Ifx_TickTime since, boolean interruptEnabled)
{
    Ifx_TickTime stmNow;
...
# 385 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) Ifx_TickTime timingNoInterruptStart(boolean *interruptEnabled)
{
...
# 399 "./0_Src/SrvSw/SysSe/Bsp/Bsp.h"
static inline __attribute__ ((always_inline)) void wait(Ifx_TickTime timeout)
{
    Ifx_TickTime deadLine = getDeadLine(timeout);
...
# 1 "./0_Src/SrvSw/StdIf/IfxStdIf_DPipe.h" 1
# 44 "./0_Src/SrvSw/StdIf/IfxStdIf_DPipe.h"
# 1 "./0_Src/SrvSw/StdIf/IfxStdIf.h" 1
# 97 "./0_Src/SrvSw/StdIf/IfxStdIf.h"
typedef void *IfxStdIf_InterfaceDriver;
# 45 "./0_Src/SrvSw/StdIf/IfxStdIf_DPipe.h" 2
...
# 28 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c" 2
# 1 "./0_Src/SrvSw/SysSe/Comm/Ifx_Console.h" 1
# 38 "./0_Src/SrvSw/SysSe/Comm/Ifx_Console.h"
typedef struct
{
...
# 60 "./0_Src/SrvSw/SysSe/Comm/Ifx_Console.h"
...
# 29 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c" 2
# 37 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
typedef struct
{
  IfxAsclin_Asc asc;
  IfxStdIf_DPipe standardIo;
  uint8 ascTxBuffer[(512) + sizeof(Ifx_Fifo) + 8];
  uint8 ascRxBuffer[(512) + sizeof(Ifx_Fifo) + 8];
} Ifx_AscIf;
...
void IfxAsclin_Asc_Init(void) {
  ...
  IfxAsclin_Asc_Config ascConfig;
     ...
     ascConfig.interrupt.txPriority = 13;
     ascConfig.interrupt.rxPriority = 12;
     ascConfig.interrupt.erPriority = 14;
     ascConfig.interrupt.typeOfService = (IfxSrc_Tos)IfxCpu_getCoreId();


     ascConfig.txBuffer = &Ifx_g_AscIf.ascTxBuffer;
     ascConfig.txBufferSize = (512);

     ascConfig.rxBuffer = &Ifx_g_AscIf.ascRxBuffer;
     ascConfig.rxBufferSize = (512);
...
void initConsole(void)
{
 ...
 Ifx_Console_init(&Ifx_g_AscIf.standardIo);
    ...
    Ifx_Console_print("----------------------------------""\r\n");
    Ifx_Console_print("LWIP Demo Input & Output			 ""\r\n");
    Ifx_Console_print("----------------------------------""\r\n");
}
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""asclin0RxISR"",""0"",""12" );extern void __attribute__ ((interrupt_handler)) asclin0RxISR(); void asclin0RxISR (void);
# 145 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
void asclin0RxISR()
{
...
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""asclin0ErISR"",""0"",""14" );extern void __attribute__ ((interrupt_handler)) asclin0ErISR(); void asclin0ErISR (void);
# 166 "0_Src/0_AppSw/Config/Common/Asc_Cfg.c"
void asclin0ErISR()
{
