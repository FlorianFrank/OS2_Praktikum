# 1 "0_Src/0_AppSw/Fat_fs/mmc.c"
# 1 "C:\\betriebssys\\BaseFramework_TC26xB//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Fat_fs/mmc.c"
# 15 "0_Src/0_AppSw/Fat_fs/mmc.c"
...
# 16 "0_Src/0_AppSw/Fat_fs/mmc.c" 2
...
# 17 "0_Src/0_AppSw/Fat_fs/mmc.c" 2
# 1 "0_Src/0_AppSw/Fat_fs/diskio.h" 1
# 16 "0_Src/0_AppSw/Fat_fs/diskio.h"
...
# 17 "0_Src/0_AppSw/Fat_fs/diskio.h" 2
...
# 18 "0_Src/0_AppSw/Fat_fs/mmc.c" 2
# 64 "0_Src/0_AppSw/Fat_fs/mmc.c"
typedef struct
{
    struct
    {
...
# 81 "0_Src/0_AppSw/Fat_fs/mmc.c"
#pragma section
#pragma section ".bss_cpu0" awc0
# 115 "0_Src/0_AppSw/Fat_fs/mmc.c"
...
#pragma section
# 140 "0_Src/0_AppSw/Fat_fs/mmc.c"
void xmit_spi (
 BYTE dat
)
{
...
# 179 "0_Src/0_AppSw/Fat_fs/mmc.c"
BYTE rcvr_spi (void)
{
    uint8 rx_data;
...
# 218 "0_Src/0_AppSw/Fat_fs/mmc.c"
int wait_ready (
 UINT wt
)
{
...
void deselect (void)
{
 { IfxPort_setPinHigh(IfxQspi1_SLSO9_P10_5_OUT.pin.port, IfxQspi1_SLSO9_P10_5_OUT.pin.pinIndex); };
 rcvr_spi();
}
...
int select (void)
{
 { IfxPort_setPinLow(IfxQspi1_SLSO9_P10_5_OUT.pin.port, IfxQspi1_SLSO9_P10_5_OUT.pin.pinIndex); };
 rcvr_spi();
     ...
     IfxQspi_SpiMaster_ChannelConfig spiMasterChannelConfig;
        {
            ...
            const IfxQspi_SpiMaster_Output slsOutput = {&IfxQspi1_SLSO9_P10_5_OUT,
...
# 365 "0_Src/0_AppSw/Fat_fs/mmc.c"
int xmit_datablock (
 const BYTE *buff,
 BYTE token
)
...
# 445 "0_Src/0_AppSw/Fat_fs/mmc.c"
...
)
{
 ...
 power_on();
 { SpiIf_ChConfig chConfig; chConfig.baudrate = 300000; chConfig.mode.shiftClock = SpiIf_ShiftClock_shiftTransmitDataOnTrailingEdge; chConfig.mode.clockPolarity = SpiIf_ClockPolarity_idleLow; chConfig.mode.parityCheck = 0; IfxQspi_SpiMaster_writeExtendedConfiguration(&g_Qspi_Mmc.drivers.spiMasterChannel, IfxQspi_calculateExtendedConfigurationValue(g_Qspi_Mmc.drivers.spiMaster->qspi, 0, &chConfig));};
 for (n = 10; n; n--)
  { rcvr_spi();
 ...
 if (ty) {
  { IfxQspi_SpiMaster_writeExtendedConfiguration(&g_Qspi_Mmc.drivers.spiMasterChannel, 0x0381);};
  Stat &= ~0x01;
 } else {
  power_off();
  Stat = 0x01;
...
# 557 "0_Src/0_AppSw/Fat_fs/mmc.c"
DRESULT disk_write (
 BYTE drv,
 const BYTE *buff,
 DWORD sector,
...
# 599 "0_Src/0_AppSw/Fat_fs/mmc.c"
DRESULT disk_ioctl (
 BYTE drv,
 BYTE ctrl,
 void *buff
...
# 728 "0_Src/0_AppSw/Fat_fs/mmc.c"
void disk_timerproc (void)
{
 ...
 n = pv;
 pv = IfxPort_P15_8.port->IN.U & (0 | 0x1<<IfxPort_P15_8.pinIndex);
 ...
 if (n == pv) {
  ...
  if (1 && (pv & 0x1<<IfxPort_P15_8.pinIndex))
   s |= (0x02 | 0x01);
  else
   s &= ~0x02;
