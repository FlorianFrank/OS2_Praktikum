...
xmit_spi:
.LFB334:
	.file 1 "0_Src/0_AppSw/Fat_fs/mmc.c"
	.loc 1 143 0
.LVL0:
	movh.a	%a12, hi:g_Qspi_Mmc+4
	lea	%a12, [%a12] lo:g_Qspi_Mmc+4
	sub.a	%SP, 8
.LCFI0:
	.loc 1 143 0
	mov	%d15, %d4
...
.LFB335:
	.loc 1 163 0
.LVL5:
	movh.a	%a15, hi:g_Qspi_Mmc+4
	.loc 1 163 0
	mov.aa	%a12, %a4
	mov	%d15, %d4
	lea	%a15, [%a15] lo:g_Qspi_Mmc+4
.LVL6:
.L10:
...
.LVL8:
.LFE335:
	.size	xmit_spi_multi, .-xmit_spi_multi
	.align 1
	.global	rcvr_spi
...
.LVL15:
.LFE337:
	.size	rcvr_spi_multi, .-rcvr_spi_multi
	.align 1
	.global	wait_ready
...
.LVL16:
	...
	mul.u	%e4, %d4, %d15
.LVL17:
	movh.a	%a15, hi:Timer2
	extr.u	%d15, %d5, 3, 16
	st.h	[%a15] lo:Timer2, %d15
	.loc 1 228 0
	lea	%a15, [%a15] lo:Timer2
	j	.L26
.L30:
	ld.hu	%d15, [%a15]0
	jz	%d15, .L29
...
.LFB339:
	.loc 1 240 0
	.loc 1 241 0
	movh.a	%a15, hi:IfxQspi1_SLSO9_P10_5_OUT
	lea	%a15, [%a15] lo:IfxQspi1_SLSO9_P10_5_OUT
.LBB93:
.LBB94:
.LBB95:
...
.LBE110:
	.loc 1 275 0
	movh.a	%a15, hi:g_Qspi_Mmc
	.loc 1 273 0
	call	qspi1_init
.LVL28:
	.loc 1 275 0
	ld.a	%a3, [%a15] lo:g_Qspi_Mmc
	lea	%a13, [%a15] lo:g_Qspi_Mmc
	jeq.a	%a3, %a2, .L37
.LBB117:
.LBB118:
	.loc 1 290 0
...
.LVL29:
	...
	ld.w	%d15, [%SP] 12
	.loc 1 303 0
	movh.a	%a12, hi:IfxQspi1_SLSO9_P10_5_OUT
	.loc 1 293 0
	insert	%d15, %d15, 8, 6, 6
	.loc 1 303 0
	lea	%a12, [%a12] lo:IfxQspi1_SLSO9_P10_5_OUT
	.loc 1 297 0
	insert	%d15, %d15, 0, 13, 9
	.loc 1 308 0
	lea	%a4, [%a13] 4
	.loc 1 297 0
...
.LVL38:
	...
	mov.aa	%a12, %a4
	.loc 1 345 0
	st.h	[%a15] lo:Timer1, %d15
	.loc 1 341 0
	mov	%d8, %d4
	.loc 1 349 0
	lea	%a15, [%a15] lo:Timer1
	j	.L45
.LVL39:
.L50:
...
.LCFI3:
	...
	.loc 1 453 0
	movh.a	%a15, hi:Stat
	ld.bu	%d15, [%a15] lo:Stat
	jz.t	%d15, 1, .L110
.LVL89:
.L94:
	.loc 1 495 0
	ld.bu	%d2, [%a15] lo:Stat
	ret
.LVL90:
.L100:
	.loc 1 496 0
...
.LBB176:
	.loc 1 456 0
	movh.a	%a2, hi:g_Qspi_Mmc
	st.w	[%SP] 4, %d15
	ld.w	%d15, [%SP] 8
	lea	%a12, [%a2] lo:g_Qspi_Mmc
	insert	%d15, %d15, 2, 3, 2
	ld.a	%a2, [%a2] lo:g_Qspi_Mmc
...
.LBB166:
.LBB167:
	.file 6 "./0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.h"
	.loc 6 891 0
	ld.a	%a2, [%a12] 4
.LBB168:
.LBB169:
...
.L80:
	.loc 1 484 0
	mov	%d15, 0
	movh.a	%a2, hi:CardType
	st.b	[%a2] lo:CardType, %d15
.LBB177:
.LBB178:
	.loc 1 241 0
	movh.a	%a2, hi:IfxQspi1_SLSO9_P10_5_OUT
	lea	%a2, [%a2] lo:IfxQspi1_SLSO9_P10_5_OUT
.LBB179:
.LBB180:
.LBB181:
	.loc 2 568 0
...
.L111:
	...
	mov	%d15, 100
.LVL108:
	movh.a	%a14, hi:Timer1
	.loc 1 464 0
	mov	%d4, 8
	mov	%d5, 426
	.loc 1 463 0
	st.h	[%a14] lo:Timer1, %d15
	.loc 1 464 0
	call	send_cmd
.LVL109:
	jne	%d2, 1, .L81
...
.LVL113:
	...
	ne	%d15, %d15, 170
	jnz	%d15, .L80
	movh.a	%a13, hi:Timer1
	lea	%a13, [%a13] lo:Timer1
	j	.L85
.L83:
...
.L164:
	.loc 1 643 0
	movh.a	%a12, hi:CardType
	ld.bu	%d15, [%a12] lo:CardType
	jz.t	%d15, 2, .L175
	.loc 1 644 0
	mov	%e4, 141
.LVL200:
...
.L212:
	...
	extr.u	%d15, %d15, 0, 16
	.loc 1 740 0
	movh.a	%a15, hi:pv.18884
	ld.hu	%d2, [%a15] lo:pv.18884
.LVL257:
	.loc 1 741 0
	st.h	[%a15] lo:pv.18884, %d15
.LVL258:
	.loc 1 743 0
	jeq	%d2, %d15, .L223
	ret
...
.Letext0:
	...
	.file 9 "./0_Src/4_McHal/Tricore/_Reg/IfxQspi_regdef.h"
	.file 10 "./0_Src/4_McHal/Tricore/_Reg/IfxPort_regdef.h"
	.file 11 "./0_Src/4_McHal/Tricore/_PinMap/IfxQspi_PinMap.h"
	.file 12 "./0_Src/4_McHal/Tricore/_Reg/IfxCpu_regdef.h"
	.file 13 "./0_Src/4_McHal/Tricore/_Impl/IfxDma_cfg.h"
	.file 14 "./0_Src/4_McHal/Tricore/_Reg/IfxDma_regdef.h"
	.file 15 "./0_Src/4_McHal/Tricore/Dma/Dma/IfxDma_Dma.h"
	.file 16 "./0_Src/SrvSw/If/SpiIf.h"
	.file 17 "0_Src/0_AppSw/Fat_fs/integer.h"
	.file 18 "0_Src/0_AppSw/Fat_fs/diskio.h"
	.file 19 "./0_Src/4_McHal/Tricore/_PinMap/IfxPort_PinMap.h"
	.file 20 "./0_Src/0_AppSw/Qspi/Qspi1.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/0_AppSw/Fat_fs/mmc.c"
	...
	.byte	0
	.uleb128 0x23
	.string	"IfxQspi_writeExtendedConfiguration"
	.byte	0x5
	.uahalf	0x40d
	.byte	0x1
	.byte	0x3
	...
	.uaword	0x8dbb
	.uleb128 0x23
	.string	"IfxQspi_SpiMaster_writeExtendedConfiguration"
	.byte	0x6
	.uahalf	0x378
	.byte	0x1
	.byte	0x3
