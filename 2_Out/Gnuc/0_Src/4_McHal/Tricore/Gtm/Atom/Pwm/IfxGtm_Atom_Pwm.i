...
# 184 "0_Src/4_McHal/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h"
extern boolean IfxGtm_Atom_Pwm_init(IfxGtm_Atom_Pwm_Driver *driver, IfxGtm_Atom_Pwm_Config *config);
...
boolean IfxGtm_Atom_Pwm_init(IfxGtm_Atom_Pwm_Driver *driver, IfxGtm_Atom_Pwm_Config *config)
{
    ...
    IfxGtm_Atom_Agc_enableChannel(agc, config->atomChannel, 1, config->synchronousUpdateEnabled == 0 ? 1 : 0);
    IfxGtm_Atom_Agc_enableChannelOutput(agc, config->atomChannel, 1, config->synchronousUpdateEnabled == 0 ? 1 : 0);
