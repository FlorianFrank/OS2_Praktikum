...
RT_DRUID_OUT_DIR=0_Src/OS/Config
...
$(ERIKA_OS_CONFIG_FILES): $(ERIKA_OS_OIL_FILE)
	...
	@echo 'EE_SRCS= 0_Src/OS/config/src/eecfg.c' >>$(RT_DRUID_OUT_DIR)/cfg/cfg.mk
	@echo 'EE_INCPATH= -I./0_Src/OS/config/inc' >>$(RT_DRUID_OUT_DIR)/cfg/cfg.mk
