...
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 6, 7, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 11, 12, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 16, 17, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 22, 23, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 27, 28, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 32, 33, 6, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 6, 7, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 11, 12, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 16, 17, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 22, 23, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 27, 28, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 32, 33, 10, &timedlg_select_up_down, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 8, 15, 13, &timedlg_select_ok, &timedlg_display, &timedlg_input,"", 0x0},
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 24, 31, 13, &timedlg_select_cancel, &timedlg_display, &timedlg_input,"", 0x0}
};
...
{(CYAN << 4) | BLACK, (BLACK << 4) | YELLOW, 16, 23, 9, &calibration_select_cancel, &calibration_display, &calibration_input,"", 0x0}
};
