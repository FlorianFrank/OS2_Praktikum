 ...
 **************************************************************************/
    ...
    const EE_UREG EE_std_thread_tos[EE_MAX_TASK+1] = {
        ...
        0U,	/* IFX_OSTASK_50MS */
        0U,	/* IFX_OSTASK_100MS */
        0U,	/* IFX_OSTASK_BEEPER */
        0U,	/* IFX_OSTASK_1000MS */
 ...
 **************************************************************************/
    ...
    DeclareTask(IFX_OSTASK_BEEPER);
    DeclareTask(IFX_OSTASK_1000MS);
    ...
    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        ...
        &EE_oo_thread_stub,		 /* thread IFX_OSTASK_BEEPER */
        &EE_oo_thread_stub,		 /* thread IFX_OSTASK_1000MS */
    ...
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        ...
        0x2U,		 /* thread IFX_OSTASK_BEEPER */
        0x1U,		 /* thread IFX_OSTASK_1000MS */
    ...
    EE_TYPENACT EE_th_rnact[EE_MAX_TASK] = {
        ...
        1U,		 /* thread IFX_OSTASK_BEEPER */
        1U,		 /* thread IFX_OSTASK_1000MS */
 ...
 **************************************************************************/
    const EE_oo_alarm_ROM_type   EE_alarm_ROM[] = {
        ...
        {0, EE_ALARM_ACTION_TASK    , IFX_OSTASK_100MS, 0U, (EE_VOID_CALLBACK)NULL, -1 },
        {0, EE_ALARM_ACTION_TASK    , IFX_OSTASK_BEEPER, 0U, (EE_VOID_CALLBACK)NULL, -1 },
        {0, EE_ALARM_ACTION_TASK    , IFX_OSTASK_BLINK, 0U, (EE_VOID_CALLBACK)NULL, -1 }
    };
